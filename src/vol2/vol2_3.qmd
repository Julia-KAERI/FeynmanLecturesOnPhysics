...
원통좌표계 $(r,\,\theta,\,z )$ 를 생각하고 $\bf{I}=I\hat{\bf{z}}$ 라고 하자. $\bf{B}=B_r\hat{\bf{r}} + B_\theta\hat{\bf{\theta}} + B_z\hat{\bf{z}}$ 라고 하면 $\nabla \times \bf{B}$ 는
$$
\nabla \times \bf{B}= \dfrac{1}{r}\left(\dfrac{\partial B_z}{\partial \theta}- \dfrac{\partial (r B_\theta)}{\partial z}\right)\hat{\bf{r}} + \left(\dfrac{\partial B_r}{\partial z} - \dfrac{\partial B_z}{\partial r}\right)\hat{\bf{\theta}} + \dfrac{1}{r}\left(\dfrac{\partial (r B_\theta)}{\partial r} - \dfrac{\partial B_r}{\partial \theta}\right)\hat{\bf{z}}
$$

이며, $\bf{J}=J\hat{\bf{z}}$ 이다. 따라서 

$$
\dfrac{1}{r}\left(B_\theta + r\dfrac{\partial B_\theta}{\partial \theta}\right) = \mu_0 J
$$
